...
namespace siteComponente.BussinessLogic.Core
{
     public class ProductApi
     {
          ...
          public List<Product> CategoryProducts(int id, string searchBy, string searchValue)
          {
               List<Product> products = null;
               using (var db = new ProductsContext())
               {
               ...
               if (products != null)
               {
                    ...
                    else
                    {
                         ...
                         {
                              List<Product> searchByProductName = products.Where(p => p.Name.ToLower().Contains(searchValue.ToLower())).ToList();
